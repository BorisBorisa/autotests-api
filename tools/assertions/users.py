...
def assert_get_user_response(
    ...
    """
    Сравнение данных пользователя при создании с данными при запросе.

    :param get_user_response: Ответ запроса получения данных пользователя.
    :param create_user_response: Ответ при создании пользователя.
    :return: AssertionError: Если не совпадают.
    """
